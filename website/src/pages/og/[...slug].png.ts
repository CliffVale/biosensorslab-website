...
export async function getStaticPaths() {
  ...
  const pages = [
    ...
    { slug: 'pi', title: 'Principal Investigator', subtitle: 'Dr. Naveen Kumar Singh' },
    { slug: 'funding', title: 'Funding', subtitle: 'Research Support & Grants' },
    { slug: 'courses', title: 'Courses', subtitle: 'Teaching at IIT Delhi' },
    { slug: 'gallery', title: 'Gallery', subtitle: 'Life in the Lab' },
    { slug: 'contact', title: 'Contact Us', subtitle: 'Get in Touch' },
    { slug: 'important-links', title: 'Important Links', subtitle: 'Useful Resources' },
  ];
...
export async function GET({ params, props }: { params: any; props: any }) {
  ...
  const icons: Record<string, string> = {
    pi: "M12 2a5 5 0 100 10 5 5 0 000-10zm0 13c-4.42 0-8 1.79-8 4v3h16v-3c0-2.21-3.58-4-8-4z", // User
    funding: "M3 21h18v-2H3v2zM5 17h14V7H5v10zm2-8h10v6H7V9zM12 2L2 6h20L12 2z", // Landmark
    courses: "M12 3L1 9l11 6 9-4.91V17h2V9L12 3zM5 13.18v2.73C5 17.6 8.13 19 12 19s7-1.4 7-3.09v-2.73l-7 3.82-7-3.82z", // GraduationCap
    gallery: "M21 19V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2zM8.5 13.5l2.5 3 3.5-4.5 4.5 6H5l3.5-4.5z", // Camera
    contact: "M20 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z", // Mail
    "important-links": "M10.59 13.41a1 1 0 001.41 0l4.24-4.24a3 3 0 10-4.24-4.24L10.17 6.76a1 1 0 101.42 1.42l1.83-1.83a1 1 0 111.42 1.42l-4.25 4.22a1 1 0 000 1.42zm2.82-2.82a1 1 0 00-1.41 0l-4.24 4.24a3 3 0 104.24 4.24l1.83-1.83a1 1 0 10-1.42-1.42l-1.83 1.83a1 1 0 11-1.42-1.42l4.25-4.22a1 1 0 000-1.42z", // ExternalLink
    ...
    equipment: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z", // Flask (equipment)
  };
